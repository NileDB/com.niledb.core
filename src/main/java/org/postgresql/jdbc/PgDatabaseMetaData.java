/*
 * PATCHED class
 * He tenido que tocar esta clase para que el método getColumns me devuelva también los campos de un composite type y
 * poder así hacer las diferencias teniendo en cuenta los tipos personalizados.
 * 
 * relkind = 'c' He tenido que añadir 'c' al filtro:
 * WHERE c.relkind in ('r','p','v','f','m','c')
 *
...
public class PgDatabaseMetaData implements DatabaseMetaData {
  ...
  public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern,
    ...
    sql += "pg_catalog.pg_get_expr(def.adbin, def.adrelid) AS adsrc,dsc.description,t.typbasetype,t.typtype "
           ...
           + " WHERE c.relkind in ('r','p','v','f','m','c') and a.attnum > 0 AND NOT a.attisdropped ";
